...
CREATE TABLESPACE hf1 DATAFILE 'C:\Users\DELL\hf1.dbf' SIZE 10M;
    Tablespace created.
CREATE TABLESPACE hf2 DATAFILE 'C:\Users\DELL\hf2.dbf' SIZE 10M;
    Tablespace created.
CREATE TABLESPACE hf3 DATAFILE 'C:\Users\DELL\hf3.dbf' SIZE 10M; 
    Tablespace created.
CREATE TABLESPACE hf4 DATAFILE 'C:\Users\DELL\hf4.dbf' SIZE 10M;
    Tablespace created.
...
exec dbms_stats.gather_table_stats('DELL','sales');
...
INSERT INTO EMPLOYEE1 values('3','52','10','70');
    1 row created.
exec dbms_stats.gather_table_stats('DELL','EMPLOYEE1');
    PL/SQL procedure successfully completed.
...
exec dbms_stats.gather_table_stats('DELL','date_data');
    PL/SQL procedure successfully completed.
...
exec dbms_stats.gather_table_stats('DELL','supplier_parts');
PL/SQL procedure successfully completed.
...
CREATE TABLE COMPOSITE_RANGE (
	...
	SUBPARTITION TEMPLATE (
		...
		INSERT INTO COMPOSITE_RANGE VALUES ( 1001, 'harshal', 'MH', TO_DATE('1/04/2014','DD/MM/YYYY'));
...
CREATE TABLE LIST_HASH (
	...
	SUBPARTITION TEMPLATE (
		...
		INSERT INTO LIST_HASH VALUES ( 1001, 'harshal', 'OR', TO_DATE('1/04/2014','DD/MM/YYYY'));
...
INSERT INTO LIST_LIST VALUES ( 1, 'harshal', 'OR', TO_DATE('1/04/2014','DD/MM/YYYY'));
...
SQL>  EXEC DBMS_STATS.GATHER_TABLE_STATS('harshal', 'RANGE_HASH');
...
CREATE TABLE LIST_RANGE (
	...
	SUBPARTITION TEMPLATE (
		...
		INSERT INTO LIST_RANGE VALUES ( 1001, 'harshal', 'OR', TO_DATE('1/04/2014','DD/MM/YYYY'));
...
SQL> EXEC DBMS_STATS.GATHER_TABLE_STATS('harshal', 'LIST_RANGE');
