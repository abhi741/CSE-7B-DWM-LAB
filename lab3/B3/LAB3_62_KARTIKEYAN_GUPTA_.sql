...
SQL> exec dbms_stats.gather_table_stats('KARTIKEYAN62','SALES');
...
SQL> exec dbms_stats.gather_table_stats('KARTIKEYAN','SALES');
BEGIN dbms_stats.gather_table_stats('KARTIKEYAN','SALES'); END;

*
ERROR at line 1:
ORA-20000: Unable to analyze TABLE "KARTIKEYAN"."SALES", insufficient
...
SQL> exec dbms_stats.gather_table_stats('KARTIKEYAN','SALES_BY_REGION');
BEGIN dbms_stats.gather_table_stats('KARTIKEYAN','SALES_BY_REGION'); END;

*
ERROR at line 1:
ORA-20000: Unable to analyze TABLE "KARTIKEYAN"."SALES_BY_REGION", insufficient
privileges or does not exist
ORA-06512: at "SYS.DBMS_STATS", line 20327
ORA-06512: at "SYS.DBMS_STATS", line 20360
ORA-06512: at line 1
...
SQL> exec dbms_stats.gather_table_stats('KARTIKEYAN62','SALES_BY_REGION');
...
SQL> exec dbms_stats.gather_table_stats('KARTIKEYAN62','EMP');
...
SQL> exec dbms_stats.gather_table_stats('KARTIKEYAN62','date_data');
...
SQL> exec dbms_stats.gather_table_stats('KARTIKEYAN62','supplier_parts');
...
SQL> exec dbms_stats.gather_table_stats('KARTIKEYAN62','sales_1');
...
SQL> exec dbms_stats.gather_table_stats('KARTIKEYAN62','porders');
...
SQL> exec dbms_stats.gather_table_stats('KARTIKEYAN62','rorders');
...
SQL> insert into v_emp values(101,'kartikeyan',30000,5000);
insert into v_emp values(101,'kartikeyan',30000,5000)
            *
ERROR at line 1:
ORA-00947: not enough values


SQL> insert into v_emp values(102,'ganmeet',20000,4000);
insert into v_emp values(102,'ganmeet',20000,4000)
            *
ERROR at line 1:
ORA-00947: not enough values
...
SQL> insert into v_emp values(104,'god',100000,5000);
insert into v_emp values(104,'god',100000,5000)
            *
ERROR at line 1:
ORA-00947: not enough values
...
SQL> insert into v_emp(emp_id,emp_name,fixed_salary,variable_salary) values(101,'kartikeyan',30000,5000);

1 row created.

SQL> insert into v_emp(emp_id,emp_name,fixed_salary,variable_salary) values(102,'ganmeet',20000,4000);
...
SQL> insert into v_emp(emp_id,emp_name,fixed_salary,variable_salary) values(104,'god',100000,5000);

1 row created.

SQL> exec dbms_stats.gather_table_stats('KARTIKEYAN62','v_emp');
...
SQL>
SQL> exec dbms_stats.gather_table_stats('KARTIKEYAN62','quarterly_regional_sales');
