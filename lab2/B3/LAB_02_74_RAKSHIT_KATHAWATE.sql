...
/*
CHANNEL_DESC         CO CALENDAR         CH         MO GROUPING(COUNTRIES.COUNTRY_ISO_CODE)
-------------------- -- -------- ---------- ---------- ------------------------------------
...
/*
RESULT : GROUPING ID VALUE SHOWS THE DECIMAL REPRESENTATION OF DIMMENSIONAL SUM ,
	EX: 1 1 1 => 7 => SUM IS APPLIED ACROSS ALL THE 3 DIMMENSIONS
		0 1 1 => 3 => SUM IS APPLIED ACROSS LAST TWO DIMMENSIONS
*/
