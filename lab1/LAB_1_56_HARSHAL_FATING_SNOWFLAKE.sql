...
CREATE TABLE consignor_address1 (
                consignor_address_id VARCHAR2(3) NOT NULL,
                street VARCHAR2(20) NOT NULL,
                Appartment VARCHAR2(20) NOT NULL,
                Area VARCHAR2(20) NOT NULL,
                CONSTRAINT CONSIGNOR_ADDRESS1_PK PRIMARY KEY (consignor_address_id)
);
...
CREATE TABLE consignor (
                ...
                CONSTRAINT CONSIGNOR_PK PRIMARY KEY (consignor_id, consignor_address_id)
);
...
ALTER TABLE consignor ADD CONSTRAINT CONSIGNOR_ADDRESS1_CONSIGNO847
FOREIGN KEY (consignor_address_id)
REFERENCES consignor_address1 (consignor_address_id)
NOT DEFERRABLE;
