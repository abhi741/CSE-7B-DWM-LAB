...
CREATE TABLE supplier (
                supplier_id_pk VARCHAR2(4) NOT NULL,
                supplier_name VARCHAR2(3) NOT NULL,
                CONSTRAINT SUPPLIER_PK PRIMARY KEY (supplier_id_pk)
);
...
CREATE TABLE Product (
                ...
                CONSTRAINT PRODUCT_KEY_PK PRIMARY KEY (product_key_pk, supplier_id_pk)
);
...
CREATE TABLE Sales (
                ...
                CONSTRAINT SALES_PK PRIMARY KEY (sales_key_pk, store_key_pk, promotion_key_pk, time_key_pk, product_key, supplier_id_pk)
);


ALTER TABLE Product ADD CONSTRAINT SUPPLIER_PRODUCT_FK
FOREIGN KEY (supplier_id_pk)
REFERENCES supplier (supplier_id_pk)
NOT DEFERRABLE;
...
FOREIGN KEY (product_key, supplier_id_pk)
REFERENCES Product (product_key_pk, supplier_id_pk)
NOT DEFERRABLE;
